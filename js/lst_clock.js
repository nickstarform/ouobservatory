...
function calculate() {
    ...
    clock_div.innerHTML = "<font face=Courier color=#000080> Coordinated Universal Time (UTC) &nbsp;" +cuth + ":"  +cutm+":"+cuts+"<br>Greenwich Local Sidereal Time &nbsp;&nbsp;&nbsp;&nbsp;" +gmt_ch + ":"  + gmt_cmin  + ":" +gmt_csecs+"<br>Durham Local Sidereal Time &nbsp; &nbsp; &nbsp; &nbsp;" +ch + ":"  + cmin  + ":" +csecs+ "</font>";
